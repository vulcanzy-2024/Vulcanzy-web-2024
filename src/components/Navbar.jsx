...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-white text-sm font-light">NIT Andhra Pradesh</p>
            </div>
          </div>
      ...
      {/* Drawer */}
      {isDrawerOpen && (
        <div className="md:hidden bg-opacity-90 backdrop-filter backdrop-blur-sm fixed inset-0 bg-gray-800">
          {/* Drawer content */}
