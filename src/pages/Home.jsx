    ...
    <>
      <div className=" bg-[#808080]/50 flex justify-around items-center h-[100dvh] w-[100%] overflow-clip relative">
        ...
        <div className="flex w-[45%] flex-col justify-center items-center">
          <p className="text-white text-[1.8rem] sm:text-[3.3rem] md:text-[4.456rem] lg:text-[5.5rem] font-cdb">
            {" "}
            VULCANZY{" "}
          </p>
          <p className="font-cdb text-white sm:text-[1.8rem] md:text-[2.4rem] ">
            Cultural Fest
          </p>
      ...
      <div className="bg-black flex justify-center items-center h-[40rem] w-full ">
        <div className="w-[35%]">
          <img src={wave} alt="" />
        </div>
      ...
      <div className="bg-black -z-20 w-full  sm:h-[50rem] relative overflow-clip flex items-center justify-start">
      ...
      <div className="bg-black   h-[100dvh] w-full flex justify-center items-center overflow-clip relative -z-20">
        <div className="bg-right_wave scale-150 bg-cover w-[20rem] h-[20rem] sm:w-[25rem] md:w-[30rem]  absolute -right-[10rem] sm:-right-[12rem] md:-right-[16rem]   -z-10"></div>
        <div className="bg-left_wave scale-150 w-[20rem] bg-cover h-[20rem]  sm:w-[25rem] md:w-[30rem]  absolute -left-[10rem] sm:-left-[12rem] md:-left-[16rem] md:top-0 -z-10"></div>
        <div className="grid grid-cols-2 gap-12 grid-rows-2 justify-items-center   w-[85%] h-full">
          <div className="  bg-pink_drop  self-center w-[20rem] h-[20rem] sm:w-[25rem]  sm:h-[25rem] md:w-[35rem] md:h-[35rem] bg-cover flex justify-center items-center">
            <p className="font-cdb sm:text-xl  text-center  ">Events</p>
          </div>
          <div className="bg-blue_drop  self-center w-[20rem] h-[20rem] sm:w-[25rem]  sm:h-[25rem] md:w-[35rem] md:h-[35rem]  bg-cover flex justify-center items-center">
            <p className="font-cdb sm:text-xl  text-center  ">Gallery</p>
          </div>
          <div className="  col-span-2 self-center  flex justify-center">
            <div className="  bg-purple_drop  w-[25rem] h-[25rem]  sm:w-[30rem]  sm:h-[30rem] md:w-[35rem] md:h-[35rem]  bg-cover flex justify-center items-center -mt-60 sm:mt-0">
      ...
      <div className="w-full h-[100dvh] bg-black flex justify-center flex-col items-center relative overflow-clip -z-30">
        ...
        <div className="bg-blue_bubbles w-[20rem] h-[20rem] absolute -right-[4rem] bottom-0 sm:w-[30rem] sm:h-[30rem] bg-cover -z-20"></div>
        <div className="bg-pastle w-[20rem] h-[20rem] sm:w-[30rem] sm:h-[30rem] absolute -left-[8rem] top-5 sm:-left-[12rem] sm:-top-10 bg-cover -z-20"></div>
        <div className="h-[90%]"></div>
      </div>

      <div className="bg-black flex justify-center h-[10rem] w-full items-center z-10">
